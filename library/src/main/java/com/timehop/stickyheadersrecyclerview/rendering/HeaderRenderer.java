...
public class HeaderRenderer {
    ...
    /**
     * The following field is used as a buffer for internal calculations. Its sole purpose is to
     * avoid
     ...
     * @param offset       a Rect used to define the x/y offset of the header. Specify x/y offset by
     *                     setting
    ...
    /**
     * Initializes a clipping rect for the header based on the margins of the header and the padding
     * of the
     * recycler.
     ...
     *
     * @param clipRect     {@link Rect} for clipping a provided header to the padding of a recycler
     *                     view
